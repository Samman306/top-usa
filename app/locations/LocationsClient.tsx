...
const LocationCard = ({ location }: { location: Location }) => {
  return (
    <Link
    href={`/locations/${slugify(location.state_name)}.${location.slug}`}
    ...
    <div className="relative overflow-hidden bg-gray-800 rounded-xl mb-10">
      <div className="relative px-6 py-12 sm:px-12 sm:py-16 lg:py-20 lg:px-16">
        ...
        <p className="mt-4 max-w-3xl text-xl text-gray-400">
          With offices across the country, we provide exceptional legal services wherever you are.
          Browse our locations to find the closest office or learn about our services in your area.
        </p>
    ...
    <div className="bg-gray-800 rounded-xl shadow-sm p-8 my-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-400">Our attorneys have deep knowledge of local laws and court systems in every location we serve.</p>
        </div>
        <div className="flex flex-col items-center text-center">
          <div className="h-12 w-12 rounded-md bg-gray-700 flex items-center justify-center mb-4">
            <svg className="h-6 w-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857l-4.244-4.243a8 8 0 1111.314 0z" />
            </svg>
          </div>
          <h3 className="text-lg font-medium text-white mb-2">National Network</h3>
          <p className="text-gray-400">Access to a nationwide network of legal professionals and resources to support your case.</p>
        </div>
        <div className="flex flex-col items-center text-center">
          <div className="h-12 w-12 rounded-md bg-gray-700 flex items-center justify-center mb-4">
            <svg className="h-6 w-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="text-gray-400">Legal emergencies don't wait for business hours. Our team is available whenever you need us.</p>
        </div>
      </div>
    </div>
  )
  ...
  const faqs = [
    {
      ...
      answer: "You can use our location finder above to filter by state or city. Alternatively, you can search for your city or state in the search box. Each location page will provide detailed contact information and directions."
    },
    {
      question: "Do you offer virtual consultations?",
      answer: "Yes, we offer virtual consultations for clients who cannot visit our physical locations. Contact your nearest office to schedule a video or phone consultation with one of our attorneys."
    },
    {
      question: "What practice areas are available at each location?",
      answer: "Most of our locations offer a full range of legal services including family law, personal injury, criminal defense, estate planning, and business law. Some specialized services may only be available at certain locations. Please check the specific location page for details."
    },
    {
      question: "How do I schedule an appointment?",
      answer: "You can schedule an appointment by calling the office directly, using our online appointment scheduler, or by submitting a contact form on the location's page. Our staff will follow up promptly to confirm your appointment."
    },
    {
      question: "Do you have multilingual attorneys available?",
      answer: "Yes, many of our locations have multilingual attorneys and staff. Languages available vary by location but often include Spanish, French, Mandarin, and more. Check the specific location page for language capabilities."
    }
  ]
  ...
  return (
    <div className="bg-gray-800 rounded-xl p-8 my-10 text-white">
      <div className="max-w-4xl mx-auto text-center mb-8">
        ...
        <p className="text-gray-400">With decades of experience and a nationwide network, we're ready to serve you wherever you are.</p>
      </div>
  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <h2 className="text-2xl font-bold text-yellow-600">All Cities <span className="text-sm font-normal text-gray-400">({filteredLocations.length} locations)</span></h2>
...
const StatesView = ({ locations }: { locations: Location[] }) => {
  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <h2 className="text-2xl font-bold text-yellow-600">By State <span className="text-sm font-normal text-gray-400">({filteredStates.length} states)</span></h2>
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">{state.count} {state.count === 1 ? 'City' : 'Cities'}</p>
                </div>
                {state.code && (
...
export default function LocationsClient() {
  ...
  const demoLocations = [
    { name: "New York", slug: "new-york", state_name: "New York", state_code: "NY", county_name: "New York County", population: "8336817" },
    { name: "Los Angeles", slug: "los-angeles", state_name: "California", state_code: "CA", county_name: "Los Angeles County", population: "3979576" },
    { name: "Chicago", slug: "chicago", state_name: "Illinois", state_code: "IL", county_name: "Cook County", population: "2693976" },
    { name: "Houston", slug: "houston", state_name: "Texas", state_code: "TX", county_name: "Harris County", population: "2320268" },
    { name: "Phoenix", slug: "phoenix", state_name: "Arizona", state_code: "AZ", county_name: "Maricopa County", population: "1680992" },
    { name: "Philadelphia", slug: "philadelphia", state_name: "Pennsylvania", state_code: "PA", county_name: "Philadelphia County", population: "1584064" },
    { name: "San Antonio", slug: "san-antonio", state_name: "Texas", state_code: "TX", county_name: "Bexar County", population: "1547253" },
  ];
    ...
    const fetchCities = async () => {
      try {
        ...
        if (result && result.success && Array.isArray(result.data) && result.data.length > 0) {
          ...
          const cityField = keys.find(k => /^city$|^name$|^title$/i.test(k)) || keys.find(k => /city|name|title/i.test(k)) || 'City'
          ...
          let stateField = keys.find(k => k.toLowerCase() === 'state') || 
          ...
          console.log(`Detected fields: city=${cityField}, state=${stateField}, stateCode=${stateCodeField}, all keys:`, keys)
          ...
          const findStateName = (item: any): string => {
            ...
            const commonStates = ['Alabama', 'Alaska', 'Arizona', 'Arkansas', 'California', 'Colorado', 
            ...
            if (cityName) {
              const matchingDemoCity = demoLocations.find(d => 
          ...
          const stateNames = Array.from(new Set(
            transformedLocations.map((loc: Location) => loc.state_name)
          ...
          const stateNames = Array.from(new Set(
            demoLocations.map((loc: Location) => loc.state_name)
          )).filter(Boolean).sort() as string[];
          setStates(stateNames);
        }
        ...
        // Extract states from demo locations
        const stateNames = Array.from(new Set(
          demoLocations.map(loc => loc.state_name)
        )).filter(Boolean).sort() as string[];
        setStates(stateNames);
  ...
  useEffect(() => {
    ...
    const filterTimeout = setTimeout(() => {
      ...
      if (populationFilter && populationFilter !== "") {
        filtered = filtered.filter(location => {
          const pop = location.population ? parseInt(location.population) : 0;
  ...
  }, [selectedState, selectedCity, populationFilter, locations, itemsPerPage, currentPage, practiceAreas, citySearchTerm, stateSearchTerm, selectedTab])
    ...
    <div id="locations">
      ...
      <h1 className="text-4xl font-bold mb-6" >Our Locations</h1>
        <p className="text-lg text-gray-400 mb-8 max-w-4xl">
          TOP USA LAW provides expert legal representation across the United States. Find a location near you to get started with your case.
        </p>
              ...
              <div className="mb-6">
                ...
                <div className="relative rounded-xl shadow-sm overflow-hidden transition-all duration-200 hover:shadow-md focus-within:shadow-md">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg className="h-6 w-6 text-yellow-500 transition-all duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {citySearchTerm && (
                    ...
                    >
                      <svg className="h-6 w-6 text-gray-400 transition-all duration-200 hover:text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-gray-50 rounded-lg p-6 mb-6">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-600">No cities match your search for "{citySearchTerm}". Try searching for a different city or state.</p>
                    </div>
                  </div>
                </div>
              ) : (
                ...
                <div className="bg-gray-50 rounded-lg p-6 mb-6">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-600">No states match your search for "{stateSearchTerm}". Try searching for a different state name.</p>
                    </div>
                  </div>
                </div>
              ) : (
