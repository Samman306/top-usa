...
import { ChevronsLeft, ChevronsRight, MapPin, Phone, Award, Building, Users, Map } from 'lucide-react';
      ...
      <div className="relative">
        ...
        <div className="flex flex-wrap gap-4 mb-6">
          ...
          <div className="flex items-center bg-gray-800/50 rounded-lg px-4 py-2 backdrop-blur-sm">
            ...
            <span className="text-gray-300">{cityCount} {cityCount === 1 ? 'City' : 'Cities'}</span>
          </div>
          <div className="flex items-center bg-gray-800/50 rounded-lg px-4 py-2 backdrop-blur-sm">
            <Map className="h-5 w-5 text-yellow-500 mr-2" />
            <span className="text-gray-300">{stateName} ({stateId})</span>
          </div>
        </div>
        <p className="text-xl text-gray-300 max-w-3xl mb-8">
          Expert legal representation throughout {stateName}. Our attorneys understand local laws and courts to provide you with the best possible legal service.
        </p>
  ...
  return (
    <div className="bg-gray-800 rounded-xl p-8 my-10 text-white border border-gray-700">
      <div className="max-w-4xl mx-auto text-center mb-8">
        ...
        <p className="text-gray-400">Our team of experienced attorneys is dedicated to providing you with excellent legal representation.</p>
      </div>
...
export default function StatePageContent() {
  ...
  useEffect(() => {
    const fetchCities = async () => {
      ...
      try {
        ...
        const locationsData = data.data
          if (Array.isArray(locationsData) && locationsData.length > 0) {
            ...
            const stateLocations = transformedLocations.filter(loc => 
      ...
      const filteredDemo = demoLocations.filter(loc => 
        loc.state_name.toLowerCase() === stateName.toLowerCase() || 
        loc.state_id.toLowerCase() === stateParam.toLowerCase()
      );
